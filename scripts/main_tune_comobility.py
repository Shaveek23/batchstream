...
def compose_evidently_experiments(dataset_name):
    ...
    n_online = 20
    n_first_fit = 100
    rf = Pipeline([('dt', DecisionTreeClassifier())])

    param_grid = {
        'n_curr': [50, 100, 150, 200],
    ...
    for samples in samples:
        ...
        args_list.append((get_evidently_experiment(f"{suffix}_dt", copy.deepcopy(rf), n_online=n_online, n_first_fit=n_first_fit, window_size=window_size,
