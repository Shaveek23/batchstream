...
def get_covtype_rf_adwin_target_exp(df, suffix, clock=5000, grace_period=5000, min_window_length=1000, n_online=100, windows_size=1000, n_first_fit=1000):
    prefix = str(uuid.uuid4())[:8]
    name = f'{prefix}_covtype_rf_adwin_target_{suffix}'
