...
def compose_experiments(dataset_name):
    ...
    # args_list.append((get_combining_experiment(suffix + "_MV1", [copy.deepcopy(rf), copy.deepcopy(lr), copy.deepcopy(nb)],
    ...
    # args_list.append((get_combining_experiment(suffix + "_DS1", [copy.deepcopy(rf), copy.deepcopy(lr), copy.deepcopy(nb)],
    #                                             [copy.deepcopy(lr_online), copy.deepcopy(arf)], window_size, n_curr_ref_retrain, threshold,
    ...
    # args_list.append((get_combining_experiment(suffix + "_MV2", [copy.deepcopy(xgb_batch), copy.deep(dt)], [copy.deepcopy(srp_model), copy.deepcopy(hat)], window_size, n_curr_ref_retrain, threshold,
    #     threshold, n_first_fit, n_online, is_data_drift=is_data_drift, is_target_drift=is_target_drift, is_performance=is_performance_drift, comb_type='mv'), df.copy(deep=True)))
    
    # args_list.append((get_combining_experiment(suffix + "_DS2", [copy.deepcopy(xgb_batch), copy.deep(dt)], [copy.deepcopy(srp_model), copy.deepcopy(hat)], window_size, n_curr_ref_retrain, threshold,
    #     threshold, n_first_fit, n_online, is_data_drift=is_data_drift, is_target_drift=is_target_drift, is_performance=is_performance_drift, comb_type='ds'), df.copy(deep=True)))

    args_list.append((get_combining_experiment(suffix + "_WV1", [copy.deepcopy(rf), copy.deepcopy(lr), copy.deepcopy(nb)],
                                                [copy.deepcopy(lr_online), copy.deepcopy(arf)], window_size, n_curr_ref_retrain, threshold,
    ...
    args_list.append((get_combining_experiment(suffix + "_WV2", [copy.deepcopy(xgb_batch), copy.deepcopy(dt)], [copy.deepcopy(srp_model), copy.deepcopy(hat)], window_size, n_curr_ref_retrain, threshold,
        threshold, n_first_fit, n_online, is_data_drift=is_data_drift, is_target_drift=is_target_drift, is_performance=is_performance_drift, comb_type='wv'), df.copy(deep=True)))
